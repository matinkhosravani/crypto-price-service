...
type PriceFetcherClient interface {
	Fetch(ctx context.Context, in *PriceInput, opts ...grpc.CallOption) (*PriceOutput, error)
}
...
func (c *priceFetcherClient) Fetch(ctx context.Context, in *PriceInput, opts ...grpc.CallOption) (*PriceOutput, error) {
	out := new(PriceOutput)
	err := c.cc.Invoke(ctx, "/PriceFetcher/Fetch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PriceFetcherServer interface {
	Fetch(context.Context, *PriceInput) (*PriceOutput, error)
...
func (UnimplementedPriceFetcherServer) Fetch(context.Context, *PriceInput) (*PriceOutput, error) {
...
func _PriceFetcher_Fetch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PriceFetcher/Fetch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PriceFetcherServer).Fetch(ctx, req.(*PriceInput))
	}
...
var PriceFetcher_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/price_fetch.proto",
}
